...
```{r suggests, echo= FALSE, message=FALSE}
...
```{r Topo, eval=has_tmap, echo= FALSE, message=FALSE}
...
```{r SlpAsp, eval=has_tmap, echo=FALSE}
...
```{r Qfit, eval=has_tmap & has_cowplot, echo= FALSE}
...
```{r VRM, eval=has_tmap, echo=FALSE}
...
```{r SAPA, eval=has_tmap, echo=FALSE}
...
```{r AdjSD, eval=has_tmap, echo=FALSE}
...
```{r RIE, eval=has_tmap, echo=FALSE}
...
```{r TPI, eval=has_tmap, echo=FALSE}
...
```{r DMV, eval=has_tmap, echo=FALSE}
...
```{r BPI, eval=has_tmap, echo=FALSE}
